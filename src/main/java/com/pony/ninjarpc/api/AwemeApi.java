...
import com.pony.ninjarpc.worker.TTEncryptWorker;
...
public class AwemeApi {
    ...
    @RequestMapping(value = "/ttencrypt", method = RequestMethod.POST, produces = "application/json;charset=UTF-8")
    public String ttEncrypt(@RequestBody String data) {
        return TTEncryptWorker.encrypt(data);
    }
